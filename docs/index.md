...
La explicación se hará pensando que se está utilizando linux. Para otras sistemas operativos los pasos serán similares. Además, se presupone que se tienen correctamente instalados: *git*, *python3*, *pip*, *Java-jdk* y *docker*.
